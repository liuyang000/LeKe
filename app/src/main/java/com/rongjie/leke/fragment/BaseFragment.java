...
public class BaseFragment extends Fragment implements View.OnClickListener, NoteBookView.OnUndoOptListener, NoteBookView.OnDoOptListener, ShortNoteFragment.DeleteLabelListener, ShortNoteFragment.AddLabelListener, View.OnTouchListener, MoveImageView.UpdateImageViewMapListener, SeekBar.OnSeekBarChangeListener {
    ...
    protected Button bookPackage;
    protected Button gesture;
    protected Button paintDraw;
    protected Button drawPic;
    protected Button label;
    protected Button image;
    protected Button screenshot;
    protected Button send;
    protected Button undo;
    protected Button redo;
    protected Button textbook;
    protected Button notebook;
    protected Button exerciseBook;
    protected Button bookMarker;
    protected Button directory;
    ...
    private void initBaseView() {
        ...
        bookPackage = (Button) root.findViewById(R.id.book_package);
        gesture = (Button) root.findViewById(R.id.gesture);
        paintDraw = (Button) root.findViewById(R.id.paint_draw);
        drawPic = (Button) root.findViewById(R.id.draw_pic);
        label = (Button) root.findViewById(R.id.label);
        image = (Button) root.findViewById(R.id.image);
        screenshot = (Button) root.findViewById(R.id.screenshot);
        send = (Button) root.findViewById(R.id.send);
        undo = (Button) root.findViewById(R.id.undo);
        redo = (Button) root.findViewById(R.id.redo);
        bookMarker = (Button) root.findViewById(R.id.bookmark);
        directory = (Button) root.findViewById(R.id.directory);
        textbook = (Button) root.findViewById(R.id.textbook);
        notebook = (Button) root.findViewById(R.id.notebook);
        exerciseBook = (Button) root.findViewById(R.id.exercise_book);
